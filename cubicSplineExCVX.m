...
u = linspace(eps,0.5,m);
u = 1-u;
v = norminv(u);
v  = fliplr(v);
u = fliplr(u);

a = 0.6;  b = 0.8;  % boundary points
...
cvx_begin
    ...
    %continuity conditions at point a
    [1 a a^2 ]*xl1 == [1 a a^2 ]*xl2;
    [0 1 2*a ]*xl1 == [0 1 2*a ]*xl2;
    [0 0   2 ]*xl1 == [0 0   2 ]*xl2;
    %continuity conditions at point b
    [1 b b^2 ]*xl2 == [1 b b^2 ]*xl3;
    [0 1 2*b ]*xl2 == [0 1 2*b ]*xl3;
    [0 0   2 ]*xl2 == [0 0   2 ]*xl3;
cvx_end
