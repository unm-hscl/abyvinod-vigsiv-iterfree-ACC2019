    ...
    if Delta>0.5
        ...
        cvx_begin quiet
            ...
            minimize (trace(cov_X_sans_input(1:state_offset:end,1:state_offset:end)) +...
                (xtarget(1:state_offset:end)-onopwl_mean_X(1:state_offset:end))'*Q*...
                (xtarget(1:state_offset:end)-onopwl_mean_X(1:state_offset:end))...
                +onopwl_U_vector'*R*onopwl_U_vector)
            subject to
                onopwl_mean_X == Ad*mean_X_sans_input(1:size(Ad,2))+  Bd * onopwl_U_vector;
