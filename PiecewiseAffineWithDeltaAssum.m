function [onopwl_time_to_solve,onopwl_total_time,onopwl_opt_input_vector,...
    ...
    if Delta>0.5
        ...
        cvx_begin quiet
            ...
            minimize (trace(cov_X_sans_input(1:state_offset:end,1:state_offset:end)) + (xtarget(1:state_offset:end)-onopwl_mean_X(1:state_offset:end))'*(xtarget(1:state_offset:end)-onopwl_mean_X(1:state_offset:end)))
            subject to
